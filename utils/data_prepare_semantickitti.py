...
grid_size = 0.06
dataset_path = '/mnt/sdb/3dfaceRe/data/dgcnn/data/kitti/dataset/sequences'
output_path = '/mnt/sdb/3dfaceRe/data/dgcnn/data/kitti/dataset/sequences' + '_' + str(grid_size)
