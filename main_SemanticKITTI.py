...
class SemanticKITTI:
    def __init__(self, test_id):
        ...
        self.dataset_path = '/mnt/sdb/3dfaceRe/data/dgcnn/data/kitti/dataset/sequences_0.06'
    ...
    def get_tf_mapping2():
        ...
        def tf_map(batch_pc, batch_label, batch_pc_idx, batch_cloud_idx):
            ...
            for i in range(cfg.num_layers):
                neighbour_idx = tf.compat.v1.py_func(DP.knn_search, [batch_pc, batch_pc, cfg.k_n], tf.int32)
                ...
                up_i = tf.compat.v1.py_func(DP.knn_search, [sub_points, batch_pc, 1], tf.int32)
